...
import { User, Package, Heart, Settings, Eye, Truck, Loader2 } from 'lucide-react';
  ...
  const loadProfile = async () => {
    try {
      ...
      setProfileData({
        ...
        address: '', // TODO: Add address fields to user model
        city: '',
        postalCode: ''
      });
    } catch (error) {
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            disabled
                            className="bg-gray-700 border-gray-600 text-white opacity-50 cursor-not-allowed"
                          />
                          <p className="text-xs text-gray-400">Для смены email обратитесь в поддержку</p>
                        </div>
